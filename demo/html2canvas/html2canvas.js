...
var $q = (function(){ //promise
    var defer = function() {
      ...
      var deferred = {
        ...
        notify: function(progress) {
            if(pending) pending.forEach(function(callback){
            callback[2](progress);
          });
        },
        promise: {
    ...
    var all = function(promises) {
      var deferred = defer(),
        ...
        promises.forEach(function(){counter++});
...
if (typeof(define) === 'function' && define.amd2) {
