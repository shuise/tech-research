							...
							function () {
								...
								if (typeof row.cell == 'undefined') {
                                    ...
                                    if (typeof row.cell[idx] != "undefined") {
                                        ...
                                        var _colConfig = colModel[idx];
                                        var _data = _colConfig.name;
                                        var _tpl = _colConfig.tpl;

                                        if(_tpl){
                                        	if(typeof _data == "object"){
	                                        	for(var prop in _data){
		                                        	_dataP[prop] = _data[prop];
		                                        }
                                        	}
	                                        iHTML = flexi_subs(_tpl,_dataP);
                                        }else{
                                       		iHTML = row.cell[p.colModel[idx].name];
                                        }
                                    }
...
function flexi_subs(temp, data, regexp){
