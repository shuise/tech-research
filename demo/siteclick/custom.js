(function($){
    ...
    if(/\?(\S+)/.test(location.href.replace(/#.*/, ""))){
        ...
        global.dataUrl = "custom." + global.name + ".json";
    ...
    function drawChart(name){
        ...
        global.ysNum = jsonData[name]["head"].length;
            ...
            global.canvas.dualChart(
                [{
                    title : "无'+global.cmpname+'的访问",
                    data : jsonData[day][name]['noclick']
                }],
                [{
                    title : "有'+global.cmpname+'的访问",
                    data : jsonData[day][name]['doclick']
                }],
                {
                    ...
                    Title : {title : '无'+global.cmpname+'的访问 [下图百分比基于无'+global.cmpname+'访问数：'+jsonData[day]['total']['noclick']+']'},
                ...
                },
                {
                    ...
                    showLegend : false,
                    grid:{shadow: 0, nogrid: 1},
                    Title : {title : '有'+global.cmpname+'的访问 [下图百分比基于有'+global.cmpname+'访问数：'+jsonData[day]['total']['doclick']+']'},
                    yTick : {apronum : 5, labels : "{y}", startY: [0,0]},
                    colors : ['#ffaa55']
                },
