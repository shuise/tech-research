(function($){
    ...
    var global = {
        dataUrl : /\?(\S+)/.test(location.href.replace(/#.*/, "")) ? "click" + RegExp.$1 + ".json" : "click.json",
        ...
        global.ysNum = jsonData[name]["head"].length;
            ...
            global.canvas.dualChart(
                ...
                }],
                {
                    ...
                    Title : {title : '无有效点击的访问 [下图百分比基于无有效点击访问数：'+jsonData[day]['total']['noclick']+']'},
                ...
                },
                {
                    ...
                    showLegend : false,
                    grid:{shadow: 0, nogrid: 1},
                    Title : {title : '有有效点击的访问 [下图百分比基于有有效点击访问数：'+jsonData[day]['total']['doclick']+']'},
                    yTick : {apronum : 5, labels : "{y}", startY: [0,0]},
                    colors : ['#ffaa55']
                },
