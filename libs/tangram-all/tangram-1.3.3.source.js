 ...
 * @param {string} className 元素的class，只能指定单一的class，如果为空字符串或者纯空白的字符串，返回null。
 ...
 * @function
 * @grammar baidu.array.each(source, iterator)
...
baidu.dom.draggable = function(element, options) {
    ...
    if (element && baidu.dom.getStyle(element, "position") != "static") {
